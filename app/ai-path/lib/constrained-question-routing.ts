...
export const CONSTRAINED_QUESTION_VERSION = '2026-07-18.v1' as const
...
const QUESTION_CATALOG: QuestionCatalog = Object.freeze({
  'use-case': Object.freeze({
    ...
    specification: Object.freeze([
      { id: 'specification-core', title: 'What should the AI do?', reason: 'The smallest useful version', prompt: 'Define one clear input-to-output job for the first version.' },
    ...
    risk: Object.freeze([
      { id: 'risk-core', title: 'What could go wrong?', reason: 'Where a person must stay in control', prompt: 'Set the data, consequence and approval boundaries for this use case.' },
    ...
    constraints: Object.freeze([
      { id: 'constraints-core', title: 'What must the plan fit?', reason: 'Your time, skills and budget', prompt: 'Choose the practical limits the build plan must respect.' },
  ...
  'capability-growth': Object.freeze({
    ...
    evidence: Object.freeze([
      { id: 'evidence-core', title: 'Tell us about your best example', reason: 'What you made, improved or tested', prompt: 'What is the strongest thing you have made or improved with AI?' },
    ...
    reasoning: Object.freeze([
      ...
      { id: 'reasoning-automation', title: 'How would you make an automated workflow reliable?', reason: 'Test failure cases before removing human review', prompt: 'What would you test or change before letting this workflow act automatically?', context: 'A model handles most requests correctly but occasionally produces confident, incorrect results.' , signals: [/automate-repeated-work|automation|workflow|repeated/i] },
    ...
    foundations: Object.freeze([
      { id: 'foundations-core', title: 'What are you comfortable using?', reason: 'Coding, data and AI tools', prompt: 'Choose the foundations you can use without substantial help.' },
    ...
    constraints: Object.freeze([
      { id: 'constraints-core', title: 'What must your learning plan fit?', reason: 'Your time, pace and preferred format', prompt: 'Set the practical boundaries for your learning plan.' },
...
export function parseAdaptiveQuestionRequest(value: unknown): AdaptiveQuestionRequest | null {
  ...
  const candidate = value as Record<string, unknown>
  if (!exactKeys(candidate, ['answers', 'completedSectionId', 'path', 'version'])) return null
