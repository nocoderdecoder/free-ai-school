...
const QUESTION_CATALOG: QuestionCatalog = Object.freeze({
  ...
  'capability-growth': Object.freeze({
    ...
    reasoning: Object.freeze([
      { id: 'reasoning-core', title: 'How would you check that AI actually helped?', reason: 'Use the example you just gave instead of an unrelated hypothetical', prompt: 'How would you check whether AI helped, what could go wrong, and when should a person review it?', context: 'Think about the example you just gave—or the first task you want to try.' },
