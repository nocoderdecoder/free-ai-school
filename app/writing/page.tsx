  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="max-w-3xl mx-auto px-8 py-24">
        ...
        <h1 className="text-4xl font-bold mb-4">Honest takes on AI in business.</h1>
        <p className="text-white/60 text-lg mb-16">What I am building, what is working, what failed, and what I think is actually happening in AI.</p>
        <div className="border border-white/10 rounded-xl p-8 text-center">
          <p className="text-white/40 mb-4">Posts coming soon.</p>
          <p className="text-white/60 text-sm">I publish daily on LinkedIn. Subscribe below to get longer pieces here.</p>
