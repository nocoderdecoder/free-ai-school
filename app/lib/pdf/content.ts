  ...
  'ai-for-sales-playbook': {
    ...
    sections: [
      ...
      },
      {
        ...
        columns: ['Phase', 'Weeks', 'Focus', 'Key Actions', 'Success Metric'],
        rows: [
          ['Foundation', '1–4', 'Tools + data hygiene', 'Audit CRM data quality; deploy call recording (Gong/Chorus); set up intent data feed (6sense/Bombora); define ICP in writing', '>90% CRM field completion rate'],
          ['Automation', '5–8', 'Sequences + scoring', 'Launch AI outreach sequences; activate lead scoring model; build competitive battle cards; A/B test AI vs manual emails', '20% more meetings booked per rep per week'],
          ['Optimisation', '9–12', 'Coaching + forecasting', 'Weekly Gong review sessions with managers; AI forecast live in Clari; win/loss tracking by competitor; rep performance dashboard', '15% lift in quota attainment vs prior quarter'],
        ],
      },
      {
        type: 'table',
      ...
      {
        type: 'table',
        heading: 'Top AI Tools for Sales — Comparison Matrix',
        columns: ['Tool', 'Category', 'Best For', 'Price/Month', 'CRM Integration'],
        rows: [
          ['Apollo', 'Prospecting', 'SMB and mid-market outreach at volume; built-in email sequences', '$49', 'Native CRM sync to HubSpot and Salesforce'],
          ['Clay', 'Enrichment', 'Hyper-personalised outreach using 50+ data sources and AI writing', '$149', 'Zapier + native integrations'],
          ['Outreach', 'Sequences', 'Enterprise sales engagement with AI-suggested next actions', '$100+', 'Salesforce and HubSpot native'],
          ['Gong', 'Intelligence', 'Call recording, transcription, deal intelligence, and rep coaching', '$1,200/yr/seat', 'All major CRMs'],
          ['Clari', 'Forecasting', 'Revenue operations and ML-powered pipeline prediction', '$150+', 'Salesforce native'],
          ['Lavender', 'Email', 'Real-time email grading and AI-assisted reply rate optimisation', '$29', 'Gmail and Outlook'],
          ['Perplexity', 'Research', 'Fast, sourced account and market research before calls', '$20', 'N/A — standalone research tool'],
          ['HubSpot AI', 'CRM', 'SMB all-in-one CRM with AI content, scoring, and automation built in', '$45+', 'Native'],
        ],
      },
      {
        type: 'callout',
      ...
      },
      {
        ...
        columns: ['Use Case', 'Prompt Template', 'Expected Output'],
        rows: [
          ['ICP research', '"Describe the ideal customer profile for [product] targeting [market]. Include company size, industry, role, and 3 key pain points."', 'Detailed ICP with segmentation criteria and messaging hooks'],
          ['Account research', '"Summarise [company] for a sales call. Include recent news, business model, growth signals, and likely priorities."', '5-bullet call brief ready in under 5 minutes'],
          ['Cold email', '"Write a personalised cold email to a [title] at [company] that references [trigger]. Keep it under 100 words with a soft CTA."', 'Personalised opener with specific reference and clear next step'],
          ['Objection response', '"I\'m in a sales call and the prospect said \'[objection]\'. Write 3 different ways to respond, from empathetic to direct."', 'Three response options to choose based on conversation tone'],
          ['Proposal outline', '"Create a proposal outline for [company] who wants to [goal]. Include problem, solution, ROI, timeline, and next steps."', 'Structured proposal skeleton ready to fill with specifics'],
          ['Discovery questions', '"Write 8 discovery questions for a [persona] at a [company type] evaluating [product category]."', 'Question bank covering pain, impact, timeline, and decision process'],
          ['Follow-up email', '"Write a follow-up email after a demo with [name] at [company]. Reference what we discussed and confirm [next step]."', 'Post-demo recap email with clear action items and timeline'],
          ['Competitive comparison', '"Compare [our product] vs [competitor] from the perspective of a [buyer type]. Be objective."', 'Balanced comparison brief useful for internal coaching and live calls'],
          ['Deal risk assessment', '"Here are my notes on this deal: [paste notes]. Identify the top 3 risks and what I should do about each."', 'Risk identification with specific recommended actions per risk'],
          ['Coaching feedback', '"Here is a call transcript: [paste]. Identify 3 things the rep did well and 3 specific improvements with examples."', 'Structured coaching notes with positive reinforcement and specific guidance'],
        ],
      },
    ],
  },
  ...
  'ai-for-recruiting-playbook': {
    ...
    sections: [
      ...
      },
      {
        ...
        columns: ['Phase', 'Weeks', 'Focus', 'Key Actions', 'Success Metric'],
        rows: [
          ['Audit & Foundation', '1–4', 'Data quality + tool selection', 'Audit ATS data completeness; select AI sourcing and screening tools; run bias audit on historical screening data; train team on prompting for JDs and outreach', '>80% ATS field completion; bias audit completed and documented'],
          ['Automate & Scale', '5–8', 'Outreach + screening automation', 'Launch AI outreach sequences in Beamery or Phenom; activate AI resume scoring in Ashby or Greenhouse; deploy Paradox Olivia for scheduling', '30% reduction in time-to-screen; 50% reduction in scheduling emails per role'],
          ['Optimise & Measure', '9–12', 'Quality of hire + candidate experience', 'Run quality-of-hire analysis on recent hires; launch candidate NPS survey at 30-day post-hire; optimise AI scoring weights based on 90-day performance data', '20% improvement in quality-of-hire score; candidate NPS positive'],
        ],
      },
      {
        type: 'bullets',
      ...
      },
      {
        ...
        columns: ['Use Case', 'Prompt Template', 'Expected Output'],
        rows: [
          ['Write a job description', '"Write a job description for a [title] at a [company type] in [industry]. Include: 5 must-have requirements, 3 nice-to-haves, key outcomes for the first 90 days, and a compelling value proposition. Avoid gendered language."', 'Ready-to-post JD with structured requirements, outcomes, and inclusive language'],
          ['Boolean search string', '"Create a LinkedIn Boolean search string for a [role] with experience in [skills A, B, C] who has worked at [company types] and is based in [location]."', 'Copy-paste Boolean string ready for LinkedIn Recruiter or hireEZ'],
          ['Outreach message', '"Write a 3-sentence LinkedIn InMail to a passive candidate for a [role]. Reference their [specific experience or achievement]. Lead with what is interesting about the opportunity, not a pitch about the company."', 'Personalised InMail under 100 words with specific reference and clear CTA'],
          ['Interview questions', '"Generate 6 behavioural interview questions for a [role] focused on [competency]. For each question, describe what a strong answer looks like."', 'Question bank with scoring guide ready to share with the hiring panel'],
          ['Rejection email', '"Write a respectful rejection email for a [role] candidate who made it to [stage]. Thank them genuinely and encourage future applications without making empty promises."', 'Empathetic, professional rejection that protects employer brand'],
          ['Offer negotiation prep', '"A candidate for [role] is asking for [X above budget]. Write 3 ways to respond: (1) counter with a revised offer, (2) enhance the package differently, (3) hold firm with a clear rationale."', 'Three-option negotiation playbook the recruiter can adapt on the call'],
          ['Sourcing strategy', '"Identify 5 non-obvious talent pools for a [role] in [industry]. For each, explain why they would make strong candidates and how to find and reach them."', 'Sourcing expansion ideas with specific channels and outreach angles for each pool'],
          ['Reference check questions', '"Write 8 structured reference check questions for a [role]. Focus on [key competencies] and include a follow-up probe for each question to get past surface answers."', 'Reference guide with primary and follow-up questions ready to send via SkillSurvey'],
          ['Hiring manager alignment', '"Write an intake meeting agenda for aligning with a hiring manager on a new [role]. Include sections for: must-haves, dealbreakers, success metrics for the first year, and how to define an A-player."', 'Intake agenda that surfaces alignment gaps before sourcing begins — not after offers are made'],
          ['Candidate feedback', '"Write constructive feedback for a candidate who performed well overall but gave a weak answer on [topic]. Be specific, encouraging, and professional — the goal is to help them in future processes."', 'Feedback email that builds goodwill and protects employer brand even in rejection'],
        ],
      },
    ],
  },
